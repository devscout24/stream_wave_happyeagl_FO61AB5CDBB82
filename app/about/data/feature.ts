export const features = [
  {
    ...
    description:
      "Understands context, tone, and intent — delivering human-like responses that actually make sense.",
  },
  {
    icon: "/lock-password-solid-standard.svg",
    title: "Private & Secure",
    description:
      "Your data stays yours. End-to-end privacy built in, with no tracking or third-party sharing.",
  },
  {
    icon: "/sun-cloud-fast-wind.svg",
    title: "Fast & Efficient",
    description:
      "Get accurate responses in seconds — from writing help to daily planning and research.",
  },
  {
    icon: "/tools-solid-standard.svg",
    title: "Integrates with Your Tools",
    description:
      "Easily connects with your workflow — Google Docs, Notion, calendars, and more.",
  },
];
